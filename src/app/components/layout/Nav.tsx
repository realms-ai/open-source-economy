      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="h-16 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3">
            <span className="relative block" style={{ width: 56, height: 40 }}>
              <Image
                src={logoSrc}
                alt=""
                fill
            ...
            <span className="text-white text-lg leading-tight font-medium flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              className="md:hidden inline-flex items-center justify-center rounded-lg p-2 text-white/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
        ...
        {/* Mobile sheet */}
        {open && (
          <nav aria-label="Mobile" className="md:hidden pb-4">
